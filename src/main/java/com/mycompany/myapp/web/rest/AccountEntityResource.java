...
public class AccountEntityResource {
    ...
    public ResponseEntity<AccountEntity> createAccountEntity(@Valid @RequestBody AccountEntity accountEntity) throws URISyntaxException {
    ...
    public ResponseEntity<AccountEntity> updateAccountEntity(@Valid @RequestBody AccountEntity accountEntity) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, accountEntity.getId().toString()))
            .body(result);
    }
