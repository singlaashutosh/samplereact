...
import { ITransactionEntityProps, TransactionEntity } from './transaction-entity';
...
export const AccountEntityDetail = (props: IAccountEntityDetailProps) => {
 ...
 /*  export const TransactionEntityDetail = (propss: ITransactionEntityDetailProps) => {
    useEffect(() => {
      props.getTransactionByAccountEntities(props.match.params.id);
  ...
  return (
    <Row>
      ...
      <div>
            <TransactionEntity {...it}></TransactionEntity>
      </div>
      </Col>
    </Row>
  );
