...
export interface ITransactionEntityProps extends StateProps, DispatchProps, RouteComponentProps< { id?: string }> {}
...
export const TransactionEntity = (props: ITransactionEntityProps) => {
  useEffect(() => {
    props.getTransactionByAccountEntities(Number(props.match.params.id));
  }, []);
...
const mapDispatchToProps = {
  getTransactionByAccountEntities,
};
